...
> [KRM function](https://github.com/kubernetes-sigs/kustomize/blob/master/cmd/config/docs/api-conventions/functions-spec.md) ⭐ 12,164 | 🐛 182 | 🌐 Go | 📅 2026-09-15.

### Generators

* [KSops](https://github.com/viaduct-ai/kustomize-sops) ⭐ 852 | 🐛 36 | 🌐 Go | 📅 2026-07-10 - Generating Secrets from sops-encrypted files (Exec).
* [SopsSecretGenerator](https://github.com/goabout/kustomize-sopssecretgenerator/) ⭐ 115 | 🐛 3 | 🌐 Go | 📅 2024-04-11 - Generating Secrets from sops-encrypted files (Exec KRM, Exec).
...
* [Merger](https://github.com/aabouzaid/kustomize-plugin-merger) ⭐ 39 | 🐛 2 | 🌐 Go | 📅 2026-09-16 - Generating manifests seamlessly by extending Kustomize merge strategies using schemaless StrategicMerge (Containerized KRM, Exec KRM).
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 16,081 | 🐛 91 | 🌐 Shell | 📅 2026-09-03 - A curated list of awesome Kubernetes resources.
* [Awesome Helm](https://github.com/cdwv/awesome-helm) ⭐ 1,111 | 🐛 9 | 📅 2026-05-16 - A curated list of awesome Helm charts and resources.
